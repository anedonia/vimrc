"[200~" URL: https://vim.wikia.com/wiki/Example_vimrc
...
"     designed
"     " for keeping undo history after closing Vim entirely. Vim will complain
"     if you
...
"     " which are considered to add usability. Which, if any, of these options
"     to
...
"     keep
"     " the same indent as the line you're currently on. Useful for READMEs,
"     etc.
    set autoindent
"
